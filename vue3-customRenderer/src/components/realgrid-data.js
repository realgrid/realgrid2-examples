...
export const columns = [{
  ...
  },
  {
    ...
    editable: true,
    values: ['START', 'CONNECT'],
    labels: ['START', 'CONNECT'],
    editButtonVisibility: 'always', // 편집기의 버튼
    editor: {
      type: 'dropdown',
      domainOnly: true,
      textReadOnly: true, // 키보드를 이용한 입력 금지 여부
      // partialMatch: false, // 한글 초성 입력 시 해당 값으로 이동 여부
    }
  },
  {
    name: 'FullName',
