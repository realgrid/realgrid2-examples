...
(function () {
    ...
    UI.addClass({
        ...
        return function () {
            ...
            var handleMoveEvent = {
                "on": function on(item) {
                    jQuery(document.body).on(ENM["mousemove"] + ".lopalette-" + _this.instanceId, function (e) {
                        var mouseObj = getMousePosition(e),
                        ...
                        mouseObj = null;
                        da = null;
                    }).on(ENM["mouseup"] + ".lopalette-" + _this.instanceId, function (e) {
                        handleMoveEvent.off();
                        U.stopEvent(e);
                    }).on("mouseleave.lopalette-" + _this.instanceId, function (e) {
                        handleMoveEvent.off();
                        U.stopEvent(e);
                    });
                ...
                "off": function off() {
                    ...
                    jQuery(document.body).off(ENM["mousemove"] + ".lopalette-" + _this.instanceId).off(ENM["mouseup"] + ".lopalette-" + _this.instanceId).off("mouseleave.lopalette-" + _this.instanceId);
            ...
            var repaint = function repaint(selectedColor) {
                ...
                // 각 패널들을 캐싱~
                _this.$ = {
                    "root": _this.$target.find('[data-lopalette-container="root"]'),
                    "colors": _this.$target.find('[data-lopalette-container="colors"]'),
                    "controls": _this.$target.find('[data-lopalette-container="controls"]')
                };
                ...
                _this.$["colors"].find('[data-lopalette-color-index]').each(function () {
                    var idx = this.getAttribute("data-lopalette-color-index");
             ...
             * @example
             * ```js
             * myPalette = new luplino.ui.palette({
             *  target: $('[data-lopalette="01"]'),
            ...
            this.init = function () {
                ...
                if (!cfg.target) {
                    console.log(luplino.info.getError("lopalette", "401", "setConfig"));
                }
            ...
            /**
             * @method lopalette.setSelectedColor
             * @param selectedColor
             * @returns {lopalette}
             */
...
(function () {
    ...
    PALETTE.tmpl = {
        ...
        get: function get(tmplName, data, columnKeys) {
            return luplino.mustache.render(PALETTE.tmpl[tmplName].call(this, columnKeys), data);
        }
    };
})();