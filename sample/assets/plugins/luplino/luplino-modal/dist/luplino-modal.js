...
(function () {
    ...
    UI.addClass({
        ...
        return function () {
            ...
            var onStateChanged = function onStateChanged(opts, that) {
                ...
                getContent = function getContent(modalId, opts) {
                    ...
                    if (data.iframe && typeof data.iframe.param === "string") {
                        data.iframe.param = luplino.util.param(data.iframe.param);
                    }
                ...
                open = function open(opts, callback) {
                    ...
                    // bind key event
                    if (opts.closeToEsc) {
                        jQuery(window).bind("keydown.lo-modal", function (e) {
                            onkeyup.call(this, e || window.event);
                        }.bind(this));
                    }

                    jQuery(window).bind("resize.lo-modal", function (e) {
                    ...
                    this.activeModal.off(ENM["mousedown"]).off("dragstart").on(ENM["mousedown"], "[data-lomodal-resizer]", function (e) {
                        if (opts.disableDrag || opts.isFullScreen) return false;
                        self.mousePosition = getMousePosition(e);
                        resizeModal.on.call(self, this.getAttribute("data-lomodal-resizer"));
                    }).on("dragstart", function (e) {
                        U.stopEvent(e.originalEvent);
                        return false;
                    });
                ...
                moveModal = {
                    on: function on() {
                        ...
                        self.resizerBg = jQuery('<div class="lomodal-resizer-background" ondragstart="return false;"></div>');
                        self.resizer = jQuery('<div class="lomodal-resizer" ondragstart="return false;"></div>');
                        ...
                        jQuery(document.body).on(ENM["mousemove"] + ".lomodal-move-" + this.instanceId, function (e) {
                            self.resizer.css(getResizerPosition(e));
                        }).on(ENM["mouseup"] + ".lomodal-move-" + this.instanceId, function (e) {
                            moveModal.off.call(self);
                        }).on("mouseleave.lomodal-move-" + this.instanceId, function (e) {
                            moveModal.off.call(self);
                        });
                    ...
                    off: function off() {
                        ...
                        jQuery(document.body).off(ENM["mousemove"] + ".lomodal-move-" + this.instanceId).off(ENM["mouseup"] + ".lomodal-move-" + this.instanceId).off("mouseleave.lomodal-move-" + this.instanceId);
                ...
                resizeModal = {
                    on: function on(resizerType) {
                        ...
                        jQuery(document.body).bind(ENM["mousemove"] + ".lomodal-resize-" + this.instanceId, function (e) {
                            self.resizer.css(getResizerPosition(e));
                        }).bind(ENM["mouseup"] + ".lomodal-resize-" + this.instanceId, function (e) {
                            resizeModal.off.call(self);
                        }).bind("mouseleave.lomodal-resize-" + this.instanceId, function (e) {
                            resizeModal.off.call(self);
                        });
                    ...
                    off: function off() {
                        ...
                        jQuery(document.body).unbind(ENM["mousemove"] + ".lomodal-resize-" + this.instanceId).unbind(ENM["mouseup"] + ".lomodal-resize-" + this.instanceId).unbind("mouseleave.lomodal-resize-" + this.instanceId);
             ...
             * @param {Function} [config.onStateChanged] - `onStateChanged` function can be defined in setConfig method or new luplino.ui.modal initialization method. However, you can us to define an event function after initialization, if necessary
            ...
            this.close = function (_option) {
                ...
                if (this.activeModal) {
                    ...
                    jQuery(window).unbind("keydown.lo-modal");
                    jQuery(window).unbind("resize.lo-modal");
            ...
            /**
             * @method lomodal.setModalConfig
             * @param _config
             * @returns {luplino.ui.lomodal}
             */
    ...
    MODAL = luplino.ui.modal;
})();

// luplino.ui.modal.tmpl
(function () {
    var MODAL = luplino.ui.modal;

    var content = function content() {
        return " \n        <div id=\"{{modalId}}\" data-modal-els=\"root\" class=\"lomodal {{theme}} {{fullscreen}}\" style=\"{{styles}}\">\n            {{#header}}\n            <div class=\"lo-modal-header\" data-modal-els=\"header\">\n                {{{title}}}\n                {{#btns}}\n                    <div class=\"lo-modal-header-addon\">\n                    {{#@each}}\n                    <button tabindex=\"-1\" data-modal-header-btn=\"{{@key}}\" class=\"{{@value.theme}}\">{{{@value.label}}}</button>\n                    {{/@each}}\n                    </div>\n                {{/btns}}\n            </div>\n            {{/header}}\n            <div class=\"lo-modal-body\" data-modal-els=\"body\">\n            {{#iframe}}\n                <div data-modal-els=\"iframe-wrap\" style=\"-webkit-overflow-scrolling: touch; overflow: auto;position: relative;\">\n                    <table data-modal-els=\"iframe-loading\" style=\"width:100%;height:100%;\"><tr><td style=\"text-align: center;vertical-align: middle\">{{{iframeLoadingMsg}}}</td></tr></table>\n                    <iframe name=\"{{modalId}}-frame\" src=\"\" width=\"100%\" height=\"100%\" frameborder=\"0\" data-modal-els=\"iframe\" style=\"position: absolute;left:0;top:0;\"></iframe>\n                </div>\n                <form name=\"{{modalId}}-form\" data-modal-els=\"iframe-form\">\n                <input type=\"hidden\" name=\"modalId\" value=\"{{modalId}}\" />\n                {{#param}}\n                {{#@each}}\n                <input type=\"hidden\" name=\"{{@key}}\" value=\"{{@value}}\" />\n                {{/@each}}\n                {{/param}}\n                </form>\n            {{/iframe}}\n            {{^iframe}}\n                <div data-modal-els=\"body-frame\" style=\"position: absolute;left:0;top:0;width:100%;height:100%;\"></div>\n            {{/iframe}}\n            </div>\n            {{^disableResize}}\n            <div data-lomodal-resizer=\"top\"></div>\n            <div data-lomodal-resizer=\"right\"></div>\n            <div data-lomodal-resizer=\"bottom\"></div>\n            <div data-lomodal-resizer=\"left\"></div>\n            <div data-lomodal-resizer=\"top-left\"></div>\n            <div data-lomodal-resizer=\"top-right\"></div>\n            <div data-lomodal-resizer=\"bottom-left\"></div>\n            <div data-lomodal-resizer=\"bottom-right\"></div>\n            {{/disableResize}}\n        </div>\n        ";
    };
    ...
    MODAL.tmpl = {
        ...
        get: function get(tmplName, data, columnKeys) {
            return luplino.mustache.render(MODAL.tmpl[tmplName].call(this, columnKeys), data);
        }
    };
})();