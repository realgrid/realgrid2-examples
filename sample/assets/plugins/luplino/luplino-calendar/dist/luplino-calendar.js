...
(function () {
    ...
    UI.addClass({
         ...
         * @example
         * ```js
         * luplino.info.months = ["1월","2월","3월","4월","5월","6월","7월","8월","9월","10월","11월"];
         ...
         * ];
         *
         * var myCalendar = new luplino.ui.calendar({
         *     control: {
         *         left: '≪',
         *         yearTmpl: '%s',
         *         monthTmpl: '%s',
        ...
        return function () {
            ...
            this.config = {
                ...
                lang: {
                    ...
                    yearTmpl: "%s",
                    months: luplino.info.months || ['JAN', 'FEB', 'MAR', 'APR', 'MAY', 'JUN', 'JUL', 'AUG', 'SEP', 'OCT', 'NOV', 'DEC'],
                    dayTmpl: "%s"
                },
            ...
            var printDay = function printDay(nowDate) {
                ...
                data = {
                    weekNames: [].concat(luplino.info.weekNames),
                    list: []
                };
            ...
            this.init = function () {
                ...
                if (!cfg.target) {
                    //console.log(luplino.info.getError("localendar", "401", "setConfig"));
                }
            ...
            /**
             * @method localendar.setSelection
            ...
            /**
             * @method localendar.getSelection
             */
            ...
            /**
             * @method localendar.setSelectable
             */
    ...
    CALENDAR = luplino.ui.calendar;
})();
// luplino.ui.calendar.tmpl
(function () {

    var CALENDAR = luplino.ui.calendar;

    var frameTmpl = function frameTmpl(columnKeys) {
        return "\n                <div class=\"lo-ui-calendar {{theme}}\" data-calendar-els=\"root\" onselectstart=\"return false;\">\n                    {{#control}}\n                    <div class=\"calendar-control\" data-calendar-els=\"control\" style=\"{{controlCSS}}\">\n                        <a class=\"date-move-left\" data-calendar-move=\"left\" style=\"{{controlButtonCSS}}\">{{{left}}}</a>\n                        <div class=\"date-display\" data-calendar-els=\"control-display\" style=\"{{controlCSS}}\"></div>\n                        <a class=\"date-move-right\" data-calendar-move=\"right\" style=\"{{controlButtonCSS}}\">{{{right}}}</a>\n                    </div>\n                    {{/control}}\n                    <div class=\"calendar-body\" data-calendar-els=\"body\"></div>\n                </div>\n                ";
    };
    ...
    CALENDAR.tmpl = {
        ...
        get: function get(tmplName, data, columnKeys) {
            return luplino.mustache.render(CALENDAR.tmpl[tmplName].call(this, columnKeys), data);
        }
    };
})();