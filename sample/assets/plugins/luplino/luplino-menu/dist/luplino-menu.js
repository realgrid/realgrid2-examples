...
(function () {
    ...
    UI.addClass({
        ...
        /**
         * @class luplino.ui.menu
         * @classdesc
         * @author jowrney@jowrney.com
         * @example
         * ```js
         * var menu = new luplino.ui.menu({
         *     theme: 'primary',
         *     iconWidth: 20,
        ...
        return function () {
            ...
            var appEventAttach = function appEventAttach(active, opt) {
                //console.log("appEventAttach:"+active);
                if (active) {

                    jQuery(document.body).off("click.lomenu-" + this.instanceId).on("click.lomenu-" + this.instanceId, clickItem.bind(this, opt));
                    //console.log("appEventAttach:active0");
                    jQuery(window).off("keydown.lomenu-" + this.instanceId).on("keydown.lomenu-" + this.instanceId, function (e) {
                        if (e.which == luplino.info.eventKeys.ESC) {
                            //console.log("appEventAttach:active1");
                            self.close();
                        }
                    });

                    jQuery(window).on("resize.lomenu-" + this.instanceId).on("resize.lomenu-" + this.instanceId, function (e) {
                        //console.log("appEventAttach:active2");
                        self.close();
                    });
                } else {
                    jQuery(document.body).off("click.lomenu-" + this.instanceId);
                    jQuery(window).off("keydown.lomenu-" + this.instanceId);
                    jQuery(window).off("resize.lomenu-" + this.instanceId);
                }
            };
                ...
                if (target) {
                    ...
                    item = function (path) {
                        ...
                        try {
                            ...
                            console.log(luplino.info.getError("lomenu", "501", "menuItemClick"));
                        }
            ...
            /**
             * @method luplino.ui.menu.getCheckValue
    ...
    MENU = luplino.ui.menu;
})();

// todo : menu 드랍다운 아이콘 설정 기능 추가
// luplino.ui.menu.tmpl
(function () {
    var MENU = luplino.ui.menu;

    var tmpl = function tmpl(columnKeys) {
        return "\n        <div class=\"lo-ui-menu {{theme}}\" {{#width}}style=\"width:{{width}}px;\"{{/width}}>\n            <div class=\"lo-menu-body\">\n                {{#" + columnKeys.items + "}}\n                    {{^@isMenu}}\n                        {{#divide}}\n                        <div class=\"lo-menu-item-divide\" data-menu-item-index=\"{{@i}}\"></div>\n                        {{/divide}}\n                        {{#html}}\n                        <div class=\"lo-menu-item-html\" data-menu-item-index=\"{{@i}}\">{{{@html}}}</div>\n                        {{/html}}\n                    {{/@isMenu}}\n                    {{#@isMenu}}\n                    <div class=\"lo-menu-item\" data-menu-item-depth=\"{{@depth}}\" data-menu-item-index=\"{{@i}}\" data-menu-item-path=\"{{@path}}.{{@i}}\">\n                        <span class=\"lo-menu-item-cell lo-menu-item-checkbox\">\n                            {{#check}}\n                            <span class=\"item-checkbox-wrap useCheckBox\" {{#checked}}data-item-checked=\"true\"{{/checked}}></span>\n                            {{/check}}\n                            {{^check}}\n                            <span class=\"item-checkbox-wrap\"></span>\n                            {{/check}}\n                        </span>\n                        {{#icon}}\n                        <span class=\"lo-menu-item-cell lo-menu-item-icon\" style=\"width:{{cfg.iconWidth}}px;\">{{{.}}}</span>\n                        {{/icon}}\n                        <span class=\"lo-menu-item-cell lo-menu-item-label\">{{{" + columnKeys.label + "}}}</span>\n                        {{#accelerator}}\n                        <span class=\"lo-menu-item-cell lo-menu-item-accelerator\" style=\"width:{{cfg.acceleratorWidth}}px;\"><span class=\"item-wrap\">{{.}}</span></span>\n                        {{/accelerator}}\n                        {{#@hasChild}}\n                        <span class=\"lo-menu-item-cell lo-menu-item-handle\">{{{cfg.icons.arrow}}}</span>\n                        {{/@hasChild}}\n                    </div>\n                    {{/@isMenu}}\n\n                {{/" + columnKeys.items + "}}\n            </div>\n            <div class=\"lo-menu-arrow\"></div>\n        </div>\n        ";
    };
    var tmplMenubar = function tmplMenubar(columnKeys) {
        return "\n        <div class=\"lo-ui-menubar {{theme}}\">\n            <div class=\"lo-menu-body\">\n                {{#" + columnKeys.items + "}}\n                    {{^@isMenu}}\n                        {{#divide}}\n                        <div class=\"lo-menu-item-divide\" data-menu-item-index=\"{{@i}}\"></div>\n                        {{/divide}}\n                        {{#html}}\n                        <div class=\"lo-menu-item-html\" data-menu-item-index=\"{{@i}}\">{{{@html}}}</div>\n                        {{/html}}\n                    {{/@isMenu}}\n                    {{#@isMenu}}\n                    <div class=\"lo-menu-item\" data-menu-item-index=\"{{@i}}\" data-has-child=\"{{@hasChild}}\">\n                        {{#icon}}\n                        <span class=\"lo-menu-item-cell lo-menu-item-icon\" style=\"width:{{cfg.iconWidth}}px;\">{{{.}}}</span>\n                        {{/icon}}\n                        <span class=\"lo-menu-item-cell lo-menu-item-label\">{{{" + columnKeys.label + "}}}</span>\n                    </div>\n                    {{/@isMenu}}\n                {{/" + columnKeys.items + "}}\n            </div>\n        </div>\n        ";
    };
    ...
    MENU.tmpl = {
        ...
        get: function get(tmplName, data, columnKeys) {
            return luplino.mustache.render(MENU.tmpl[tmplName].call(this, columnKeys), data);
        }
    };
})();