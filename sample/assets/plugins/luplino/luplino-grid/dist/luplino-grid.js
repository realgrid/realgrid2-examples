...
(function () {
    ...
    UI.addClass({
         ...
         * @example
         * ```
         * var myGrid = new luplino.ui.grid();
         * ```
         */
        return function () {
            var self = this,
            ...
            var initGrid = function initGrid() {
                ...
                this.$ = {
                    "container": {
                        "hidden": this.$target.find('[data-logrid-container="hidden"]'),
                        "root": this.$target.find('[data-logrid-container="root"]'),
                        "header": this.$target.find('[data-logrid-container="header"]'),
                        "body": this.$target.find('[data-logrid-container="body"]'),
                        "page": this.$target.find('[data-logrid-container="page"]'),
                        "scroller": this.$target.find('[data-logrid-container="scroller"]')
                    },
                    "panel": {
                        "aside-header": this.$target.find('[data-logrid-panel="aside-header"]'),
                        "left-header": this.$target.find('[data-logrid-panel="left-header"]'),
                        "header": this.$target.find('[data-logrid-panel="header"]'),
                        "header-scroll": this.$target.find('[data-logrid-panel-scroll="header"]'),
                        "right-header": this.$target.find('[data-logrid-panel="right-header"]'),
                        "top-aside-body": this.$target.find('[data-logrid-panel="top-aside-body"]'),
                        "top-left-body": this.$target.find('[data-logrid-panel="top-left-body"]'),
                        "top-body": this.$target.find('[data-logrid-panel="top-body"]'),
                        "top-body-scroll": this.$target.find('[data-logrid-panel-scroll="top-body"]'),
                        "top-right-body": this.$target.find('[data-logrid-panel="top-right-body"]'),
                        "aside-body": this.$target.find('[data-logrid-panel="aside-body"]'),
                        "aside-body-scroll": this.$target.find('[data-logrid-panel-scroll="aside-body"]'),
                        "left-body": this.$target.find('[data-logrid-panel="left-body"]'),
                        "left-body-scroll": this.$target.find('[data-logrid-panel-scroll="left-body"]'),
                        "body": this.$target.find('[data-logrid-panel="body"]'),
                        "body-scroll": this.$target.find('[data-logrid-panel-scroll="body"]'),
                        "right-body": this.$target.find('[data-logrid-panel="right-body"]'),
                        "right-body-scroll": this.$target.find('[data-logrid-panel-scroll="right-body"]'),
                        "bottom-aside-body": this.$target.find('[data-logrid-panel="bottom-aside-body"]'),
                        "bottom-left-body": this.$target.find('[data-logrid-panel="bottom-left-body"]'),
                        "bottom-body": this.$target.find('[data-logrid-panel="bottom-body"]'),
                        "bottom-body-scroll": this.$target.find('[data-logrid-panel-scroll="bottom-body"]'),
                        "bottom-right-body": this.$target.find('[data-logrid-panel="bottom-right-body"]')
                    },
                    "livePanelKeys": [], // 현재 사용중인 패널들 (grid-body repaint에서 수집하여 처리)
                    "scroller": {
                        "vertical": this.$target.find('[data-logrid-scroller="vertical"]'),
                        "vertical-bar": this.$target.find('[data-logrid-scroller="vertical-bar"]'),
                        "horizontal": this.$target.find('[data-logrid-scroller="horizontal"]'),
                        "horizontal-bar": this.$target.find('[data-logrid-scroller="horizontal-bar"]'),
                        "corner": this.$target.find('[data-logrid-scroller="corner"]')
                    },
                    "page": {
                        "navigation": this.$target.find('[data-logrid-page="navigation"]'),
                        "status": this.$target.find('[data-logrid-page="status"]')
                    },
                    "form": {
                        "clipboard": this.$target.find('[data-logrid-form="clipboard"]')
                    },
                    "resizer": {
                        "vertical": this.$target.find('[data-logrid-resizer="vertical"]'),
                        "horizontal": this.$target.find('[data-logrid-resizer="horizontal"]')
                    }
                };
             ...
             *
             * luplino.ui.grid.formatter["myType"] = function () {
             *     return "myType" + (this.value || "");
             * };
             * luplino.ui.grid.formatter["capital"] = function(){
             *     return (''+this.value).toUpperCase();
             * };
             *
             * luplino.ui.grid.collector["myType"] = function () {
             *     return "myType" + (this.value || "");
             * };
             *
             * var sampleData = [
            ...
            this.init = function (_config) {
                ...
                if (!cfg.target) {
                    console.log(luplino.info.getError("logrid", "401", "init"));
                    return this;
                }
                ...
                }).call(this, U.parseJson(this.$target.attr("data-logrid-config"), true));
                ...
                if (!this.id) this.id = this.$target.data("data-logrid-id");
                if (!this.id) {
                    //this.id = 'logrid-' + luplino.getGuid();
                    this.id = 'logrid-' + this.instanceId;
                    this.$target.data("data-logrid-id", grid.id);
                }
                ...
                jQuery(window).bind("resize.logrid-" + this.id, function () {
                    alignGrid.call(self);
                    GRID.scroller.resize.call(self);
                    GRID.body.repaint.call(self); // window resize시 repaint 함수 호출
                });

                jQuery(document.body).on("click.logrid-" + this.id, function (e) {
                    var isPickerClick = false,
                        target = U.findParentNode(e.target, function (_target) {
                            if (isPickerClick = _target.getAttribute("data-logrid-inline-edit-picker")) {
                                return true;
                            }
                            return _target.getAttribute("data-logrid-container") === "root";
                        });

                    if (target && target.getAttribute("data-logrid-instance") === this.id) {
                        self.focused = true;
                    } else {
                        self.focused = false;
                        ...
                        if (self.isInlineEditing) {
                            ...
                            if (e.metaKey || e.ctrlKey) {
                                ...
                                if (ctrlKeys[e.which]) {
                                    ...
                                    U.stopEvent(e);
                                } else if (e.which == luplino.info.eventKeys.ESC) {
                                    if (self.focused) {
                                        GRID.body.blur.call(self);
                                    }
                                } else if (e.which == luplino.info.eventKeys.RETURN || e.which == luplino.info.eventKeys.SPACE) {
                                    self.keyDown("RETURN", e.originalEvent);
                                } else if (e.which == luplino.info.eventKeys.TAB) {
                                    //self.keyDown("RETURN", e.originalEvent);
                                    U.stopEvent(e);
                ...
                jQuery(window).on("keyup.logrid-" + this.instanceId, function (e) {
                    if (self.focused) {
                        if (self.isInlineEditing) {} else {
                            if (e.metaKey || e.ctrlKey) {} else {
                                if (ctrlKeys[e.which]) {} else if (e.which == luplino.info.eventKeys.ESC) {} else if (e.which == luplino.info.eventKeys.RETURN || e.which == luplino.info.eventKeys.SPACE) {} else if (e.which == luplino.info.eventKeys.TAB) {} else if (Object.keys(self.focusedColumn).length) {
                                    self.keyDown("INLINE_EDIT", e.originalEvent);
                                }
                            }
                        }
            ...
            /**
             * @method logrid.getList
             * @param {String} _type - selected|modified|deleted
             * @returns {Array}
             * @example
             * ```js
             * loGrid.getList();
             * loGrid.getList("selected");
             * loGrid.getList("modified");
             * loGrid.getList("deleted");
             * ```
             */
            ...
            /**
             * @method logrid.setHeight
             * @param {Number} _height
             * @returns {logrid}
             * @example
             * ```js
             * loGrid.setHeight(height);
             * ```
             */
             ...
             * @example
             * ```js
             * loGrid.addRow($.extend({}, {...}), "first");
             * loGrid.addRow($.extend({}, {...}), "last", {focus: "END"});
             * loGrid.addRow($.extend({}, {...}), "last", {focus: "HOME"});
             * loGrid.addRow($.extend({}, {...}), "last", {focus: 10});
             * ```
             */
            ...
            /**
             * @method logrid.removeRow
             * @param {Number|String} [_dindex=last]
             * @returns {logrid}
             * @example
             * ```js
             * loGrid.removeRow();
             * loGrid.removeRow("first");
             * loGrid.removeRow("last");
             * loGrid.removeRow(1);
             * loGrid.removeRow("selected");
             * ```
             */
            ...
            /**
             * @method logrid.deleteRow
             * @param {Number|String} _dindex
             * @returns {logrid}
             * @example
             * ```js
             * loGrid.deleteRow("first");
             * loGrid.deleteRow("last");
             * loGrid.deleteRow(1);
             * loGrid.deleteRow("selected");
             * ```
             */
            ...
            /**
             * @method logrid.getColumnSortInfo
             ...
             * @example
             * ```js
             * logrid.setColumnSort({a:{seq:0, orderBy:"desc"}, b:{seq:1, orderBy:"asc"}});
             * ```
             */
            ...
            /**
             * @method logrid.exportExcel
             * @param {String} _fileName
             * @returns {logrid|String}
             * @example
             * ```js
            ...
            this.destroy = function () {
                ...
                this.$target.empty();
                this.list = [];
                UI.grid_instance = luplino.util.filter(UI.grid_instance, function () {
    ...
    GRID = luplino.ui.grid;
})();

// todo : filter
// todo : column reorder
// todo : editor 필수값 속성 지정
// luplino.ui.grid.body
(function () {

    var GRID = luplino.ui.grid;
    ...
    var columnSelect = {
        focusClear: function focusClear() {
            ...
            for (var c in self.focusedColumn) {
                ...
                if (_column) {
                    self.$.panel[_column.panelName].find('[data-logrid-tr-data-index="' + _column.dindex + '"]').find('[data-logrid-column-rowindex="' + _column.rowIndex + '"][data-logrid-column-colindex="' + _column.colIndex + '"]').removeAttr('data-logrid-column-focused');
                }
            }
            self.focusedColumn = {};
        },
        clear: function clear() {
            ...
            for (var c in self.selectedColumn) {
                ...
                if (_column) {
                    self.$.panel[_column.panelName].find('[data-logrid-tr-data-index="' + _column.dindex + '"]').find('[data-logrid-column-rowindex="' + _column.rowIndex + '"][data-logrid-column-colindex="' + _column.colIndex + '"]').removeAttr('data-logrid-column-selected');
                }
            }
            self.selectedColumn = {};
        },
        init: function init(column) {
            ...
            this.$.panel[column.panelName].find('[data-logrid-tr-data-index="' + column.dindex + '"]').find('[data-logrid-column-rowindex="' + column.rowIndex + '"][data-logrid-column-colindex="' + column.colIndex + '"]').attr('data-logrid-column-focused', "true").attr('data-logrid-column-selected', "true");
        ...
        update: function update(column) {
            ...
            for (var c in self.selectedColumn) {
                ...
                if (_column) {
                    self.$.panel[_column.panelName].find('[data-logrid-tr-data-index="' + _column.dindex + '"]').find('[data-logrid-column-rowindex="' + _column.rowIndex + '"][data-logrid-column-colindex="' + _column.colIndex + '"]').attr('data-logrid-column-selected', 'true');
                }
            }
        }
    };
    ...
    var columnSelector = {
        "on": function on(cell) {
            ...
            this.$["container"]["body"].on("mousemove.logrid-" + this.instanceId, '[data-logrid-column-attr="default"]', function (e) {
                if (this.getAttribute("data-logrid-column-rowIndex")) {
                    columnSelect.update.call(self, {
                        panelName: this.getAttribute("data-logrid-panel-name"),
                        dindex: Number(this.getAttribute("data-logrid-data-index")),
                        doindex: Number(this.getAttribute("data-logrid-data-o-index")),
                        rowIndex: Number(this.getAttribute("data-logrid-column-rowIndex")),
                        colIndex: Number(this.getAttribute("data-logrid-column-colIndex")),
                        colspan: Number(this.getAttribute("colspan"))
                    });
                    U.stopEvent(e);
                }
            }).on("mouseup.logrid-" + this.instanceId, function () {
                columnSelector.off.call(self);
            }).on("mouseleave.logrid-" + this.instanceId, function () {
                columnSelector.off.call(self);
            });
        ...
        "off": function off() {
            ...
            this.$["container"]["body"].off("mousemove.logrid-" + this.instanceId).off("mouseup.logrid-" + this.instanceId).off("mouseleave.logrid-" + this.instanceId);
            ...
            processor = {
                "selected": function selected(_dindex, _doindex) {
                    if (this.list[_doindex]) {
                        ...
                        while (i--) {
                            this.$.panel[this.$.livePanelKeys[i]].find('[data-logrid-tr-data-index="' + _dindex + '"]').attr("data-logrid-selected", this.list[_doindex][cfg.columnKeys.selected]);
                        }
                    }
                },
                    ...
                    if (!this.proxyList) {
                        while (di--) {
                            if (this.list[di][cfg.columnKeys.selected]) {
                                ...
                                while (pi--) {
                                    this.$.panel[this.$.livePanelKeys[pi]].find('[data-logrid-tr-data-index="' + di + '"]').attr("data-logrid-selected", false);
                                }
                            }
                ...
                "cellChecked": function cellChecked(_dindex, _doindex, _data) {
                    ...
                    this.$.panel[panelName].find('[data-logrid-tr-data-index="' + _dindex + '"]').find('[data-logrid-column-rowIndex="' + rowIndex + '"][data-logrid-column-colIndex="' + colIndex + '"]').find('[data-logrid-editor="checkbox"]').attr("data-logrid-checked", '' + _data.checked);
                }
            };
    ...
    var init = function init() {
        ...
        this.$["container"]["body"].on("click", '[data-logrid-column-attr]', function (e) {
            ...
            panelName = this.getAttribute("data-logrid-panel-name");
            attr = this.getAttribute("data-logrid-column-attr");
            row = Number(this.getAttribute("data-logrid-column-row"));
            col = Number(this.getAttribute("data-logrid-column-col"));
            rowIndex = Number(this.getAttribute("data-logrid-column-rowIndex"));
            colIndex = Number(this.getAttribute("data-logrid-column-colIndex"));
            dindex = Number(this.getAttribute("data-logrid-data-index"));
            doindex = Number(this.getAttribute("data-logrid-data-o-index"));
        ...
        this.$["container"]["body"].on("dblclick", '[data-logrid-column-attr]', function (e) {
            var panelName = void 0,
                attr = void 0,
                row = void 0,
                col = void 0,
        ...
        if (this.config.contextMenu) {
            this.$["container"]["body"].on("contextmenu", function (e) {
                ...
                target = U.findParentNode(e.target, function (t) {
                    if (t.getAttribute("data-logrid-column-attr")) {
                        return true;
                    }
                });
                ...
                if (target) {
                    // item 찾기
                    rowIndex = Number(target.getAttribute("data-logrid-column-rowIndex"));
                    colIndex = Number(target.getAttribute("data-logrid-column-colIndex"));
                    dindex = Number(target.getAttribute("data-logrid-data-index"));
                    doindex = Number(target.getAttribute("data-logrid-data-o-index"));
                    column = self.bodyRowMap[rowIndex + "_" + colIndex];
                    item = self.list[dindex];
                }

                if (!self.contextMenu) {
                    self.contextMenu = new luplino.ui.menu();
                }
        ...
        this.$["container"]["body"].on("mousedown", '[data-logrid-column-attr="default"]', function (e) {
            ...
            var valueProcessor = {
                ...
                "treeControl": function treeControl(__value) {
                    ...
                    if (_item[keys.children].length) {
                        indentNodeHtml += '<a ' + 'data-logrid-data-index="' + _index + '" ' + 'data-logrid-column-attr="tree-control" ' + 'data-logrid-tnode-arrow="" ' + 'style="width: ' + cfg.tree.arrowWidth + 'px;padding-left:' + _item[keys.depth] * cfg.tree.indentWidth + 'px;"' + '>';
                        indentNodeHtml += _item[keys.collapse] ? cfg.tree.icons.collapsedArrow : cfg.tree.icons.openedArrow;
                        indentNodeHtml += '</a>';
                    } else {
                        indentNodeHtml += '<span ' + 'data-logrid-tnode-arrow="" ' + 'style="width: ' + cfg.tree.arrowWidth + 'px;padding-left:' + _item[keys.depth] * cfg.tree.indentWidth + 'px;"' + '>&nbsp;</span>';
                    }

                    indentNodeHtml += '<span ' + 'data-logrid-tnode-item="' + (_item[keys.children].length ? 'group' : 'item') + '" ' + 'style="width: ' + cfg.tree.iconWidth + 'px;"' + '>';
                ...
                if (_list[di]) {
                    ...
                    for (tri = 0, trl = rowTable.rows.length; tri < trl; tri++) {
                        ...
                        SS.push('<tr class="tr-' + di % 4 + '', cfg.body.trStyleClass ? U.isFunction(cfg.body.trStyleClass) ? ' ' + cfg.body.trStyleClass.call({
                            item: _list[di],
                            index: di
                        }, _list[di], di) : ' ' + cfg.body.trStyleClass : '', '"', isGroupingRow ? ' data-logrid-grouping-tr="true"' : '', ' data-logrid-tr-data-index="' + di + '"', ' data-logrid-tr-data-o-index="' + odi + '"', ' data-logrid-selected="' + (_list[di][cfg.columnKeys.selected] || "false") + '"', ' data-logrid-disable-selection="' + (_list[di][cfg.columnKeys.disableSelection] || "false") + '"', '>');
                        ...
                        for (ci = 0, cl = rowTable.rows[tri].cols.length; ci < cl; ci++) {
                            ...
                            SS.push('<td ', 'data-logrid-panel-name="' + _elTargetKey + '" ', 'data-logrid-data-index="' + di + '" ', 'data-logrid-data-o-index="' + odi + '" ', 'data-logrid-column-row="' + tri + '" ', 'data-logrid-column-col="' + ci + '" ', 'data-logrid-column-rowIndex="' + col.rowIndex + '" ', 'data-logrid-column-colIndex="' + col.colIndex + '" ', 'data-logrid-column-attr="' + (col.columnAttr || "default") + '" ', function (_focusedColumn, _selectedColumn) {
                                var attrs = "";
                                if (_focusedColumn) {
                                    attrs += 'data-logrid-column-focused="true" ';
                                }
                                if (_selectedColumn) {
                                    attrs += 'data-logrid-column-selected="true" ';
                                }
                                return attrs;
                            ...
                            SS.push(function (_cellHeight) {
                                ...
                                // }
                                return '<span data-logrid-cellHolder="' + (col.multiLine ? 'multiLine' : '') + '" ' + (colAlign ? 'data-logrid-text-align="' + colAlign + '"' : '') + '" >';
                            }(cellHeight), isGroupingRow ? getGroupingValue.call(this, _list[di], di, col) : getFieldValue.call(this, _list, _list[di], di, col), '</span>');

                            SS.push('</td>');
                        }
                        SS.push('<td ', 'data-logrid-column-row="null" ', 'data-logrid-column-col="null" ', 'data-logrid-data-index="' + di + '" ', 'data-logrid-data-o-index="' + odi + '" ', 'data-logrid-column-attr="' + "default" + '" ', 'style="height: ' + cfg.body.columnHeight + 'px;min-height: 1px;" ', '></td>');
                        SS.push('</tr>');
                    }
                }
            }
        ...
        var repaintSum = function repaintSum(_elTargetKey, _colGroup, _bodyRow, _list, _scrollConfig) {
            ...
            for (tri = 0, trl = _bodyRow.rows.length; tri < trl; tri++) {
                ...
                for (ci = 0, cl = _bodyRow.rows[tri].cols.length; ci < cl; ci++) {
                    ...
                    SS.push('<td ', 'data-logrid-panel-name="' + _elTargetKey + '" ', 'data-logrid-column-row="' + tri + '" ', 'data-logrid-column-col="' + ci + '" ', 'data-logrid-column-rowIndex="' + tri + '" ', 'data-logrid-column-colIndex="' + col.colIndex + '" ', 'data-logrid-column-attr="' + (col.columnAttr || "sum") + '" ', function (_focusedColumn, _selectedColumn) {
                        var attrs = "";
                        if (_focusedColumn) {
                            attrs += 'data-logrid-column-focused="true" ';
                        }
                ...
                SS.push('<td ', 'data-logrid-column-row="null" ', 'data-logrid-column-col="null" ', 'data-logrid-column-attr="' + "sum" + '" ', 'style="height: ' + cfg.body.columnHeight + 'px;min-height: 1px;" ', '></td>');
                SS.push('</tr>');
            }
        ...
        var mergeCellsBody = function mergeCellsBody(_elTargetKey, _colGroup, _bodyRow, _list, _scrollConfig) {
            ...
            for (var ri = 0, rl = tableTrs.length; ri < rl; ri++) {
                ...
                for (var _ci = 0, cl = tableTrTds.length; _ci < cl; _ci++) {
                    ...
                    if (tdObj["$"].attr("data-logrid-column-col") != "null") {
                        tdObj.dindex = tdObj["$"].attr("data-logrid-data-index");
                        tdObj.tri = tdObj["$"].attr("data-logrid-column-row");
                        tdObj.ci = tdObj["$"].attr("data-logrid-column-col");
                        tdObj.rowIndex = tdObj["$"].attr("data-logrid-column-rowIndex");
                        tdObj.colIndex = tdObj["$"].attr("data-logrid-column-colIndex");
                    ...
                    var _loop2 = function _loop2(_ci3, _cl2) {
                        ...
                        if (!_colGroup[_ci3].editor && function () {
                            if (U.isArray(cfg.body.mergeCells)) {
                                return luplino.util.search(cfg.body.mergeCells, _colGroup[_ci3].key) > -1;
                            } else {
                                return true;
                            }
                        }()) {
    ...
    var repaintCell = function repaintCell(_panelName, _dindex, _doindex, _rowIndex, _colIndex, _newValue) {
        ...
        var updateCell = this.$["panel"][_panelName].find('[data-logrid-tr-data-index="' + _dindex + '"]').find('[data-logrid-column-rowindex="' + _rowIndex + '"][data-logrid-column-colindex="' + _colIndex + '"]').find('[data-logrid-cellholder]'),
            colGroup = this.colGroup,
                ...
                colGroup.forEach(function (col) {
                    if (col.key == updateColumnKey) {
                        var rowIndex = col.rowIndex,
                            ...
                            updateWithCell = self.$["panel"][panelName].find('[data-logrid-tr-data-index="' + _dindex + '"]').find('[data-logrid-column-rowindex="' + rowIndex + '"][data-logrid-column-colindex="' + colIndex + '"]').find('[data-logrid-cellholder]');
                ...
                if (_list[di] && _groupRow && "__isGrouping" in _list[di]) {
                    ...
                    for (tri = 0, trl = rowTable.rows.length; tri < trl; tri++) {
                        for (ci = 0, cl = rowTable.rows[tri].cols.length; ci < cl; ci++) {
                            ...
                            SS.push('<td ', 'data-logrid-panel-name="' + _elTargetKey + '" ', 'data-logrid-data-index="' + di + '" ', 'data-logrid-column-row="' + tri + '" ', 'data-logrid-column-col="' + ci + '" ', 'data-logrid-column-rowIndex="' + col.rowIndex + '" ', 'data-logrid-column-colIndex="' + col.colIndex + '" ', 'data-logrid-column-attr="' + (col.columnAttr || "default") + '" ', function (_focusedColumn, _selectedColumn) {
                                var attrs = "";
                                if (_focusedColumn) {
                                    attrs += 'data-logrid-column-focused="true" ';
                                }
                        ...
                        SS.push('<td ', 'data-logrid-column-row="null" ', 'data-logrid-column-col="null" ', 'data-logrid-data-index="' + di + '" ', 'data-logrid-column-attr="' + "default" + '" ', 'style="height: ' + cfg.body.columnHeight + 'px;min-height: 1px;" ', '></td>');
                    }
                    _elTarget.find('tr[data-logrid-tr-data-index="' + di + '"]').empty().get(0).innerHTML = SS.join('');
                }
            }
        };
    ...
    var repaintRow = function repaintRow(_dindex) {
        ...
        var replaceTr = function replaceTr(_elTargetKey, _colGroup, _bodyRow, _list, di) {
            ...
            var tr_element = _elTarget.find('tr[data-logrid-tr-data-index="' + di + '"]').empty().get(0);
            if (tr_element) {
                for (tri = 0, trl = rowTable.rows.length; tri < trl; tri++) {
                    for (ci = 0, cl = rowTable.rows[tri].cols.length; ci < cl; ci++) {
                        col = rowTable.rows[tri].cols[ci];
        ...
        var focus = {
            "UD": function UD(_dy) {
                ...
                if (this.config.body.mergeCells && this.list.length) {
                    while (!this.$.panel[nPanelInfo.panelName].find('[data-logrid-tr-data-index="' + focusedColumn.dindex + '"]').find('[data-logrid-column-rowindex="' + focusedColumn.rowIndex + '"][data-logrid-column-colindex="' + focusedColumn.colIndex + '"]').get(0)) {
                ...
                this.$.panel[focusedColumn.panelName].find('[data-logrid-tr-data-index="' + focusedColumn.dindex + '"]').find('[data-logrid-column-rowindex="' + focusedColumn.rowIndex + '"][data-logrid-column-colindex="' + focusedColumn.colIndex + '"]').attr('data-logrid-column-focused', "true");
            ...
            "LR": function LR(_dx) {
                ...
                var $column = this.$.panel[focusedColumn.panelName].find('[data-logrid-tr-data-index="' + focusedColumn.dindex + '"]').find('[data-logrid-column-rowindex="' + focusedColumn.rowIndex + '"][data-logrid-column-colindex="' + focusedColumn.colIndex + '"]').attr('data-logrid-column-focused', "true");
    ...
    var inlineEdit = {
        active: function active(_focusedColumn, _e, _initValue) {
            ...
            if (this.isInlineEditing) {
                ...
                this.inlineEditing[key].$inlineEditorCell = this.$["panel"][panelName].find('[data-logrid-tr-data-index="' + dindex + '"]').find('[data-logrid-column-rowindex="' + rowIndex + '"][data-logrid-column-colindex="' + colIndex + '"]').find('[data-logrid-cellholder]');
            ...
            var action = {
                ...
                "__clear": function __clear() {
                    ...
                    if (this.inlineEditing[_key] && this.inlineEditing[_key].$inlineEditor) {
                        var bindedAx5ui = this.inlineEditing[_key].$inlineEditor.data("binded-loui");
                        if (bindedAx5ui == "lopicker") {
                            this.inlineEditing[_key].$inlineEditor.lopicker("close");
                        } else if (bindedAx5ui == "loselect") {
                            this.inlineEditing[_key].$inlineEditor.loselect("close");
                        }
    ...
    var click = function click(_dindex, _doindex) {
        ...
        that = null;
        // console.log(this.$["panel"]["body-scroll"].find('[data-logrid-tr-data-index="' + _dindex + '"]>td:first-child'));
    };
...
(function () {
    ...
    var tableToExcel = function tableToExcel(table, fileName) {
        ...
        output = luplino.mustache.render(getExcelTmpl(), {
            worksheet: function () {
                var arr = [];
...
(function () {
    ...
    var columnResizerEvent = {
        "on": function on(_columnResizer, _colIndex) {
            ...
            jQuery(document.body).bind(GRID.util.ENM["mousemove"] + ".logrid-" + this.instanceId, function (e) {
            ...
            }).bind(GRID.util.ENM["mouseup"] + ".logrid-" + this.instanceId, function (e) {
                columnResizerEvent.off.call(self);
                U.stopEvent(e);
            }).bind("mouseleave.logrid-" + this.instanceId, function (e) {
                columnResizerEvent.off.call(self);
                U.stopEvent(e);
            });
        ...
        "off": function off() {
            ...
            jQuery(document.body).unbind(GRID.util.ENM["mousemove"] + ".logrid-" + this.instanceId).unbind(GRID.util.ENM["mouseup"] + ".logrid-" + this.instanceId).unbind("mouseleave.logrid-" + this.instanceId);
    ...
    var init = function init() {
        ...
        this.$["container"]["header"].on("click", '[data-logrid-column-attr]', function (e) {
            var key = this.getAttribute("data-logrid-column-key"),
                colIndex = this.getAttribute("data-logrid-column-colindex"),

                //rowIndex = this.getAttribute("data-logrid-column-rowindex"),
                col = self.colGroup[colIndex];

            if (key === "__checkbox_header__" && self.config.header.selector) {
                var selected = this.getAttribute("data-logrid-selected");
                selected = U.isNothing(selected) ? true : selected !== "true";

                $(this).attr("data-logrid-selected", selected);
        ...
        this.$["container"]["header"].on("mousedown", '[data-logrid-column-resizer]', function (e) {
            var colIndex = this.getAttribute("data-logrid-column-resizer");
    ...
    var getFieldValue = function getFieldValue(_col) {
        return _col.key === "__checkbox_header__" ? this.config.header.selector ? "<div class=\"checkBox\"></div>" : "&nbsp;" : _col.label || "&nbsp;";
    };
        ...
        var repaintHeader = function repaintHeader(_elTarget, _colGroup, _bodyRow) {
            ...
            for (var tri = 0, trl = _bodyRow.rows.length; tri < trl; tri++) {
                ...
                for (var ci = 0, cl = _bodyRow.rows[tri].cols.length; ci < cl; ci++) {
                    ...
                    SS.push('<td ', 'data-logrid-column-attr="' + (col.columnAttr || "default") + '" ', 'data-logrid-column-row="' + tri + '" ', 'data-logrid-column-col="' + ci + '" ', function () {
                        return typeof col.key !== "undefined" ? 'data-logrid-column-key="' + col.key + '" ' : '';
                    }(), 'data-logrid-column-colindex="' + col.colIndex + '" ', 'data-logrid-column-rowindex="' + col.rowIndex + '" ', 'colspan="' + col.colspan + '" ', 'rowspan="' + col.rowspan + '" ', 'class="' + function (_col) {
                        var tdCSS_class = "";
                    ...
                    SS.push(function () {
                        ...
                        return '<span data-logrid-cellHolder="" ' + (colAlign ? 'data-logrid-text-align="' + colAlign + '"' : '') + ' >';
                    }(), function () {
                        var _SS = "";

                        if (!U.isNothing(col.key) && !U.isNothing(col.colIndex) && (cfg.sortable === true || col.sortable === true) && col.sortable !== false) {
                            _SS += '<span data-logrid-column-sort="' + col.colIndex + '" data-logrid-column-sort-order="' + (colGroup[col.colIndex].sort || "") + '" />';
                        }
                        return _SS;
                    ...
                    if (!U.isNothing(col.colIndex)) {
                        if (cfg.enableFilter) {
                            SS.push('<span data-logrid-column-filter="' + col.colIndex + '" data-logrid-column-filter-value=""  />');
                        }
                    }

                    SS.push('</td>');
                }
                SS.push('<td ', 'data-logrid-column-row="null" ', 'data-logrid-column-col="null" ', 'style="height: ' + cfg.header.columnHeight + 'px;min-height: 1px;" ', '></td>');
                SS.push('</tr>');
            }
            SS.push('</table>');
            ...
            (function () {
                ...
                for (var cgi = 0, cgl = _colGroup.length; cgi < cgl; cgi++) {
                    ...
                    if (!U.isNothing(col.colIndex)) {
                        ...
                        AS.push('<div data-logrid-column-resizer="' + col.colIndex + '" style="height:' + resizerHeight + 'px;left: ' + (resizerLeft - 4) + 'px;"  />');
                    }
                }
                _elTarget.append(AS);
            }).call(this);
...
(function () {
    ...
    var edit_text = {
        ...
        getHtml: function getHtml(_root, _columnKey, _editor, _value) {
            ...
            return "<input type=\"text\" data-logrid-editor=\"text\" value=\"" + _value + "\" " + attributesText + ">";
        },
    ...
    var edit_money = {
        ...
        getHtml: function getHtml(_root, _columnKey, _editor, _value) {
            ...
            return '<input type="text" data-logrid-editor="money" value="' + _value + '" ' + attributesText + '" />';
        },
        init: function init(_root, _columnKey, _editor, _$parent, _value) {
            var $el = void 0;
            _$parent.append($el = jQuery(this.getHtml(_root, _columnKey, _editor, _value)));
        ...
        bindUI: function bindUI(_root, _columnKey, _$el, _editor, _$parent, _value) {
            _$el.data("binded-loui", "loformater");
            _$el.loformater($.extend(true, {
                pattern: "money"
            }, _editor.config));
            _$el.focus().select();
        }
    ...
    var edit_number = {
        ...
        getHtml: function getHtml(_root, _columnKey, _editor, _value) {
            ...
            return '<input type="text" data-logrid-editor="number" value="' + _value + '" ' + attributesText + '" />';
        },
        init: function init(_root, _columnKey, _editor, _$parent, _value) {
            var $el;
            _$parent.append($el = jQuery(this.getHtml(_root, _columnKey, _editor, _value)));
    ...
    var edit_date = {
        ...
        editMode: "popup",
        getHtml: function getHtml(_root, _columnKey, _editor, _value) {
            return '<input type="text" data-logrid-editor="calendar" value="' + _value + '" >';
        },
        init: function init(_root, _columnKey, _editor, _$parent, _value) {
            var $el;
            _$parent.append($el = jQuery(this.getHtml(_root, _columnKey, _editor, _value)));
        ...
        bindUI: function bindUI(_root, _columnKey, _$el, _editor, _$parent, _value) {
            var self = _root;
            _$el.data("binded-loui", "lopicker");

            _$el.lopicker($.extend(true, {
                direction: "auto",
                content: {
                    type: 'date',
                    formatter: {
                ...
                onStateChanged: function onStateChanged() {
                    if (this.state == "open") {
                        this.self.activePicker.attr("data-logrid-inline-edit-picker", "date");
    ...
    var edit_select = {
        ...
        getHtml: function getHtml(_root, _columnKey, _editor, _value) {
            var po = [];
            po.push('<div data-loselect="logrid-editor" data-loselect-config="{}">');
            po.push('</div>');
        ...
        bindUI: function bindUI(_root, _columnKey, _$el, _editor, _$parent, _value) {
            ...
            var self = _root;
            _$el.data("binded-loui", "loselect");
            _$el.loselect($.extend(true, {
                tabIndex: 1,
                direction: "auto",
                ...
                onStateChanged: function onStateChanged() {
                    if (this.state == "open") {
                        this.self.activeSelectOptionGroup.attr("data-logrid-inline-edit-picker", "select");
    ...
    var edit_checkbox = {
        ...
        getHtml: function getHtml(_root, _editor, _value) {
            ...
            return '<div data-logrid-editor="checkbox" data-logrid-checked="' + checked + '"></div>';
        }
    };
    ...
    var edit_textarea = {
        ...
        _getHtml: function _getHtml(_root, _columnKey, _editor, _value) {
            ...
            return "<div data-logrid-editor=\"textarea\"></div>";
        },
        _bindUI: function _bindUI(_root, _columnKey, _$el, _editor, _$parent, _value) {
            ...
            $newTextarea.on("blur", function (e) {
                ...
                $newDiv.remove();
                luplino.util.stopEvent(e.originalEvent);
            });
...
(function () {
    ...
    var navigationUpdate = function navigationUpdate() {
        ...
        if (this.page) {
            ...
            this.$["page"]["navigation"].find("[data-logrid-page-move]").on("click", function () {
                onclickPageMove.call(self, this.getAttribute("data-logrid-page-move"));
            });
        } else {
...
(function () {
    ...
    var scrollContentMover = {
        ...
        "on": function on() {
            ...
            jQuery(document.body).on("touchmove" + ".logrid-" + this.instanceId, function (e) {
            ...
            }).on("touchend" + ".logrid-" + this.instanceId, function (e) {
        ...
        "off": function off() {
            ...
            jQuery(document.body).off("touchmove" + ".logrid-" + this.instanceId).off("touchend" + ".logrid-" + this.instanceId);
    ...
    var init = function init() {
        ...
        this.$["scroller"]["vertical"].on("click", function (e) {
            if (e.target.getAttribute("data-logrid-scroller") == "vertical") {
        ...
        this.$["scroller"]["horizontal"].on("click", function (e) {
            if (e.target.getAttribute("data-logrid-scroller") == "horizontal") {
        ...
        if (luplino.info.supportTouch) {
            this.$["container"]["body"].on("touchstart", '[data-logrid-panel]', function (e) {
                self.xvar.mousePosition = GRID.util.getMousePosition(e);
...
// luplino.ui.grid.tmpl
(function () {

    var GRID = luplino.ui.grid;

    var main = function main() {
        return "<div data-logrid-container=\"root\" data-logrid-instance=\"{{instanceId}}\">\n            <div data-logrid-container=\"hidden\">\n                <textarea data-logrid-form=\"clipboard\"></textarea>\n            </div>\n            <div data-logrid-container=\"header\">\n                <div data-logrid-panel=\"aside-header\"></div>\n                <div data-logrid-panel=\"left-header\"></div>\n                <div data-logrid-panel=\"header\">\n                    <div data-logrid-panel-scroll=\"header\"></div>\n                </div>\n                <div data-logrid-panel=\"right-header\"></div>\n            </div>\n            <div data-logrid-container=\"body\">\n                <div data-logrid-panel=\"top-aside-body\"></div>\n                <div data-logrid-panel=\"top-left-body\"></div>\n                <div data-logrid-panel=\"top-body\">\n                    <div data-logrid-panel-scroll=\"top-body\"></div>\n                </div>\n                <div data-logrid-panel=\"top-right-body\"></div>\n                <div data-logrid-panel=\"aside-body\">\n                    <div data-logrid-panel-scroll=\"aside-body\"></div>\n                </div>\n                <div data-logrid-panel=\"left-body\">\n                    <div data-logrid-panel-scroll=\"left-body\"></div>\n                </div>\n                <div data-logrid-panel=\"body\">\n                    <div data-logrid-panel-scroll=\"body\"></div>\n                </div>\n                <div data-logrid-panel=\"right-body\">\n                  <div data-logrid-panel-scroll=\"right-body\"></div>\n                </div>\n                <div data-logrid-panel=\"bottom-aside-body\"></div>\n                <div data-logrid-panel=\"bottom-left-body\"></div>\n                <div data-logrid-panel=\"bottom-body\">\n                    <div data-logrid-panel-scroll=\"bottom-body\"></div>\n                </div>\n                <div data-logrid-panel=\"bottom-right-body\"></div>\n            </div>\n            <div data-logrid-container=\"page\">\n                <div data-logrid-page=\"holder\">\n                    <div data-logrid-page=\"navigation\"></div>\n                    <div data-logrid-page=\"status\"></div>\n                </div>\n            </div>\n            <div data-logrid-container=\"scroller\">\n                <div data-logrid-scroller=\"vertical\">\n                    <div data-logrid-scroller=\"vertical-bar\"></div>    \n                </div>\n                <div data-logrid-scroller=\"horizontal\">\n                    <div data-logrid-scroller=\"horizontal-bar\"></div>\n                </div>\n                <div data-logrid-scroller=\"corner\"></div>\n            </div>\n            <div data-logrid-resizer=\"vertical\"></div>\n            <div data-logrid-resizer=\"horizontal\"></div>\n        </div>";
    };

    var page_navigation = function page_navigation() {
        return "<div data-logrid-page-navigation=\"holder\">\n            {{#hasPage}}\n            <div data-logrid-page-navigation=\"cell\">    \n                {{#firstIcon}}<button type=\"button\" data-logrid-page-move=\"first\">{{{firstIcon}}}</button>{{/firstIcon}}\n                <button type=\"button\" data-logrid-page-move=\"prev\">{{{prevIcon}}}</button>\n            </div>\n            <div data-logrid-page-navigation=\"cell-paging\">\n                {{#@paging}}\n                <button type=\"button\" data-logrid-page-move=\"{{pageNo}}\" data-logrid-page-selected=\"{{selected}}\">{{pageNo}}</button>\n                {{/@paging}}\n            </div>\n            <div data-logrid-page-navigation=\"cell\">\n                <button type=\"button\" data-logrid-page-move=\"next\">{{{nextIcon}}}</button>\n                {{#lastIcon}}<button type=\"button\" data-logrid-page-move=\"last\">{{{lastIcon}}}</button>{{/lastIcon}}\n            </div>\n            {{/hasPage}}\n        </div>";
    };
    ...
    GRID.tmpl = {
        ...
        get: function get(tmplName, data, columnKeys) {
            ...
            luplino.mustache.parse(template);
            return luplino.mustache.render(template, data);
        }
    };
})();
// luplino.ui.grid.util
(function () {
    ...
    /**
     * @method logrid.util.divideTableByFrozenColumnIndex
     * @param _table
    ...
    var ENM = {
        "mousedown": luplino.info.supportTouch ? "touchstart" : "mousedown",
        "mousemove": luplino.info.supportTouch ? "touchmove" : "mousemove",
        "mouseup": luplino.info.supportTouch ? "touchend" : "mouseup"
    };
